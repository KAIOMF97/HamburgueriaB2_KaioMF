...
function carregarProdutosEstaticos() {
  produtos = {
    hamburgueres: [
      { nome: "Clássico", preco: 18, img: "images/classico.jpg" },
      { nome: "Cheddar Bacon", preco: 22, img: "images/cheddar.jpg" },
      { nome: "Duplo", preco: 25, img: "images/duplo.jpg" },
      { nome: "Frango Crocante", preco: 20, img: "images/frangocro.jpg" },
      { nome: "Vegano", preco: 21, img: "images/vegano.jpg" },
      { nome: "Barbecue", preco: 23, img: "images/barbecue.jpg" },
      { nome: "Egg Burger", preco: 19, img: "images/egg.jpg" },
      { nome: "Blue Cheese", preco: 26, img: "images/bluecheese.jpg" },
      { nome: "Chili Burger", preco: 24, img: "images/chili.jpg" },
      { nome: "Picanha", preco: 28, img: "images/picanha.jpg" },
      { nome: "Costela", preco: 30, img: "images/costela.jpg" },
      { nome: "Smash Burger", preco: 18, img: "images/smash.jpg" },
      { nome: "Onion Burger", preco: 21, img: "images/onion.jpg" },
      { nome: "Molho da Casa", preco: 22, img: "images/molho.jpg" },
      { nome: "Texano", preco: 27, img: "images/texano.jpg" },
      { nome: "Trufado", preco: 32, img: "images/trufado.jpg" },
    ],
    bebidas: [
      { nome: "Refrigerante Lata", preco: 6, img: "images/coca.png" },
      { nome: "Suco Natural", preco: 8, img: "images/suco.png" },
      { nome: "Água Mineral", preco: 4, img: "images/agua.png" },
      { nome: "Cerveja Artesanal", preco: 12, img: "images/cerveja.png" },
      { nome: "Milkshake", preco: 14, img: "images/milkshake.png" },
      { nome: "Chá Gelado", preco: 7, img: "images/cha.png" }
    ],
    sobremesas: [
      { nome: "Brownie", preco: 10, img: "images/brownie.png" },
      { nome: "Sorvete", preco: 8, img: "images/sorvete.png" },
      { nome: "Torta de Chocolate", preco: 12, img: "images/tortachocolate.png" },
      { nome: "Petit Gateau", preco: 15, img: "images/petit.png" },
      { nome: "Mousse", preco: 9, img: "images/mousse.png" }
    ]
  };
  carregarProdutos(categoriaAtual);
}
...
function carregarProdutos(categoria) {
  ...
  for (let i = 0; i < listaProdutos.length; i++) {
    ...
    card.innerHTML = `
      ...
      <input type="number" id="qtd-${categoria}-${i}" data-categoria="${categoria}" data-index="${i}" min="0" value="${qtdSalva}" onchange="atualizarSubtotal()"/>
    `;
...
function irParaCarrinho() {
  ...
  for (const categoria in produtos) {
    const listaProdutos = produtos[categoria];
    for (let i = 0; i < listaProdutos.length; i++) {
      const inputQtd = document.querySelector(`input[data-categoria="${categoria}"][data-index="${i}"]`);
  ...
  if (carrinho.length === 0) {
    alert('Adicione pelo menos um item ao carrinho antes de prosseguir!');
    return;
  }
